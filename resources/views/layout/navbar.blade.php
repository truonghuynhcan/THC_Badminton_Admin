<nav id="mainNavbar" class="navbar navbar-vertical navbar-expand-lg scrollbar bg-dark navbar-dark">
    ...
    <div class="container-fluid">
        ...
        <a class="navbar-brand" href="{{ route('dashboard') }}">
            {{-- <img src="{{asset('images/logo/logothc.png')}}" class="navbar-brand-img logo-light logo-small" alt="..." width="19" height="25">
            <img src="{{asset('images/logo/logothc.png')}}" class="navbar-brand-img logo-light logo-large" alt="..." width="125" height="25">
            <img src="{{asset('images/logo/logothc.png')}}" class="navbar-brand-img logo-dark logo-small" alt="..." width="19" height="25">
            <img src="{{asset('images/logo/logothc.png')}}" class="navbar-brand-img logo-dark logo-lager" alt="..." width="19" height="25"> --}}
            <img src="{{ asset('images/logo/logothc.png') }}" class="" alt="..." width="100" height="">
            <br>
            <strong>THC BADMINTON</strong>
        </a>
        ...
        <div class="collapse navbar-collapse" id="sidenavCollapse">
            ...
            <ul class="navbar-nav mb-lg-7">
                ...
                <!-- Post - all posts / add new post / categories-->
                <li class="nav-item dropdown">
                    <a class="nav-link" href="#PostsCollapse" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="PostsCollapse">
                        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" class="nav-link-icon" height="18" width="18">
                            <path d="M22.627 14.87 15 22.5l-3.75.75.75-3.75 7.631-7.63a2.113 2.113 0 0 1 2.991 0l.009.008a2.116 2.116 0 0 1-.004 2.992zM8.246 20.25h-6a1.5 1.5 0 0 1-1.5-1.5V2.25a1.5 1.5 0 0 1 1.5-1.5h15a1.5 1.5 0 0 1 1.5 1.5V9m-10.5-3.75h6m-9 4.5h9m-9 4.5h7.5" fill="none"
                ...
                <!-- Products - all products / add new / categories-->
                <li class="nav-item dropdown">
                    <a class="nav-link" href="#ProductsCollapse" data-bs-toggle="collapse" role="button" aria-expanded="false" aria-controls="ProductsCollapse">

                        <i class="fa-solid fa-box-archive nav-link-icon"></i>
                        <span>Products</span>
                    </a>
                    <div class="collapse" id="ProductsCollapse">
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a href="index.html" class="nav-link ">
                                    <span class="text-capitalize">All Products</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="dashboard-ecommerce.html" class="nav-link active">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="collapse" id="UsersCollapse">
                        <ul class="nav flex-column">
                            <li class="nav-item">
                                <a href="index.html" class="nav-link ">
                                    <span class="text-capitalize">All Users</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="dashboard-ecommerce.html" class="nav-link active">
                                    <span class="text-capitalize">Add new Users</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="dashboard-crm.html" class="nav-link ">
                ...
                <li class="nav-item ">
                    <a class="nav-link" href="{{ route('dashboard') }}">
                        <i class="fa-regular fa-comments nav-link-icon"></i>
                        <span>Comments</span>
                    </a>
                </li>
                <!-- Log out -->
                ...
                <li class="nav-item ">
                    <a class="nav-link" href="{{ route('logout') }}">
                        <i class="fa-solid fa-arrow-right-from-bracket nav-link-icon"></i>
                        <span>Log out</span>
                    </a>
                ...
                <div class="d-none">
                    ...
                    <li class="nav-item">
                        <a class="nav-link " href="file-manager.html">
                            <svg viewBox="0 0 24 24" class="nav-link-icon" height="18" width="18" xmlns="http://www.w3.org/2000/svg">
                                <path d="M20.25,9.75v-3a1.5,1.5,0,0,0-1.5-1.5H8.25V3.75a1.5,1.5,0,0,0-1.5-1.5H2.25a1.5,1.5,0,0,0-1.5,1.5v16.3a1.7,1.7,0,0,0,3.336.438l2.351-9.657A1.5,1.5,0,0,1,7.879,9.75H21.75A1.5,1.5,0,0,1,23.2,11.636l-2.2,9A1.5,1.5,0,0,1,19.55,21.75H2.447" fill="none"
                                    stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" />
                            </svg>
                    ...
                    <li class="nav-item">
                        <a href="docs/accordion.html" class="nav-link">
                            <svg viewBox="0 0 24 24" class="nav-link-icon" height="18" width="18" xmlns="http://www.w3.org/2000/svg">
                                <path d="M22.91,6.953,12.7,1.672a1.543,1.543,0,0,0-1.416,0L1.076,6.953a.615.615,0,0,0,0,1.094l10.209,5.281a1.543,1.543,0,0,0,1.416,0L22.91,8.047a.616.616,0,0,0,0-1.094Z" fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                                    stroke-width="1.5" />
